...
const downloadFolder = "/Users/vicki/Documents/friends/video_outputs"
const videoCutsFolder = "/Users/vicki/Documents/friends/video_cuts"
const videoFinalFolder = "/Users/vicki/Documents/friends/video_final"

let counter = 0

const dbSearchInternalPromises = []
let videoOutputs = []
...
const generateVideo = async function(wordsToLookUpArr){
    ...
    const matchedEpisodes = await Promise.all(dbSearchInternalPromises)
    ...
    let finalCommands = []
    let intermediateCommands = []

    const cutVideoFiles = fs.readdirSync(videoCutsFolder)
